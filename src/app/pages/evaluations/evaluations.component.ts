...
export class EvaluationsComponent implements OnInit {
  ...
  startTest() {
    if (this.isLoadingQuestions || this.loadingError || !this.questions.length)
      return;
  ...
  finishTest() {
    ...
    localStorage.setItem(
      ...
      JSON.stringify(this.profileScores),
    );
    ...
    forkJoin({
      ...
      error: () => {
        ...
        this.toastService.showToast(
          'Mostramos tu perfil local. El resultado quedó guardado y se sincronizará automáticamente.',
          'info',
        );
