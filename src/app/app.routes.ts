...
export const routes: Routes = [
  ...
  {
    path: 'evaluations/calibration/:id',
    loadComponent: () =>
      import('./pages/evaluations/hobbies-test/hobbies-test.component').then(
        (m) => m.HobbiesTestComponent,
      ),
    canActivate: [authGuard, missionUnlockGuard],
  },
  {
    path: 'test-result',
    loadComponent: () =>
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/career-simulator/career-simulator-catalog/career-simulator-catalog.component').then(
        (m) => m.CareerSimulatorCatalogComponent,
      ),
    canActivate: [authGuard],
  },
  {
    path: 'career-simulator/:slug',
    loadComponent: () =>
      import('./features/career-simulator/career-simulator.component').then(
        (m) => m.CareerSimulatorComponent,
      ),
    canActivate: [authGuard],
  },
  {
    path: 'career-simulator/:slug/result',
    loadComponent: () =>
      import('./features/career-simulator/career-simulator-result/career-simulator-result.component').then(
        (m) => m.CareerSimulatorResultComponent,
      ),
    canActivate: [authGuard],
  },
  ...
  },
  {
    path: 'profile/manage',
    loadComponent: () =>
      import('./pages/profile/manage-profile/manage-profile.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/profile/notifications/notifications.component').then(
  ...
  },
  {
    path: 'profile/help',
    loadComponent: () =>
      import('./pages/profile/help-center/help-center.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/profile/contact-support/contact-support.component').then(
  ...
  },
  {
    path: 'profile/about',
    loadComponent: () =>
      import('./pages/profile/about-app/about-app.component').then(
        (m) => m.AboutAppComponent,
      ),
    canActivate: [authGuard],
  },
  {
    path: 'mapa-universidades',
    loadComponent: () =>
      import('./features/universities-map/universities-map.component').then(
        (m) => m.UniversitiesMapComponent,
      ),
    canActivate: [authGuard],
  },
  {
